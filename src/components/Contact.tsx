		...
		>
			...
			<div>
				<p className="mb-8 leading-relaxed text-slate-400">
					Reach out for full-stack development opportunities, product
					engineering roles, internships, collaborations, or project
					discussions.
				</p>
...
function FieldError({ children }: { children: React.ReactNode }) {
	return (
		<p className="mt-1.5 text-xs font-medium text-rose-400">{children}</p>
	);
}
