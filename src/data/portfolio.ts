export const profile = {
  ...
  blurb:
    "Bengaluru-based full-stack developer focused on clean systems, thoughtful UX, and recruiter-ready product craft.",
...
export const projects = [
  ...
  },
  {
    ...
    tech: ["React.js", "TypeScript", "Tailwind CSS", "Node.js", "Prisma", "SQL"],
...
export const education = [
  {
    ...
    detail:
      "Bachelor of Engineering in Computer Science and Engineering with focus on software development, web technologies, databases, and engineering fundamentals.",
    metric: "8.18 CGPA",
  },
  {
